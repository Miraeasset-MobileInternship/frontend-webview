            ...
            <CardContent sx={{height:'100%', padding:0.5, }}>
                ...
                <div style={{height: '30%', display:"flex", alignItems:'center',}}>
                    <Typography variant="h5" component="div" style={{paddingLeft:7}}>
                        <MainText style={{paddingRight:10}}>{price}{currency}</MainText>
                        {changePrice >= 0 ? (
                            <>
                ...
                <div style={{display: "flex", flexDirection: 'row',
                    padding:7, height: '35%'}}>
                    <CustomBtn style={{backgroundColor: "#FFF5F5"}} onClick={navigateToBuy}>
                        <ButtonText style={{color: "#FF484E"}}>{"매수하기"}</ButtonText>
                    </CustomBtn>
                    <div style={{padding:5}}/>
                    {sellAvailable ?
                        (
                            <CustomBtn style={{backgroundColor: "#F2FAFF"}} onClick={navigateToSell}>
                                <ButtonText style={{color: "#026BFB"}}>{"매도하기"}</ButtonText>
                            </CustomBtn>
                        )
                        :
                            (
